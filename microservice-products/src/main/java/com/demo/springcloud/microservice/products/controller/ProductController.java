...
public class ProductController {
    ...
    @Operation(summary = "Obtener listado de productos", description = "Obtiene listado de productos", method = "GET")
    @GetMapping(produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<List<ProductResponse>> findAll() {
        return new ResponseEntity<>(this.productService.findAll(), HttpStatus.OK);
    }

    @Operation(summary = "Obtener producto por id", description = "Obtiene producto por id", method = "GET")
    @GetMapping(path = "/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<ProductResponse> findById(@PathVariable Long id) {
        return new ResponseEntity<>(this.productService.findById(id), HttpStatus.OK);
    }

    @Operation(summary = "Crear producto", description = "Crea un producto", method = "POST")
    ...
    @Operation(summary = "Actualiza producto", description = "Actualiza un producto", method = "PUT")
    ...
    @Operation(summary = "Elimina producto", description = "Elimina un producto", method = "DELETE")
